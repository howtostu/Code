%%FIGURE 5  R4/R6
% the 1st line
R1=1.5;e1=2;B=2.5;e2=2;C4=0;R3=1.5;R4=1.12;L1=1.2;e3=6;C6=0;R5=1;R6=0.61;L2=0.7;e4=4;
for i=0.5
    figure(1)
...
% the 2nd line
R1=1.5;e1=2;B=2.5;e2=2;C4=0;R3=1.5;R4=2.25;L1=1.2;e3=6;C6=0;R5=1;R6=1.22;L2=0.7;e4=4;
for j=0.3
...
%%{
%the 3rd line
R1=1.5;e1=2;B=2.5;e2=2;C4=0;R3=1.5;R4=3;L1=1.2;e3=6;C6=0;R5=1;R6=2;L2=0.7;e4=4;
for k=0.3
    ...
    grid on
    hold on  
    legend({'R4=1.12,R6=0.6','R4=2.25,R6=0.61','R4=3,R6=2'},'location','northeast');
end
%%}
% the small figure
