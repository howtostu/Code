% FIGURE 9
R1=2.3;e1=2;B=2.5;e2=2;C4=0.6;R3=1.5;R4=3;L1=1.2;e3=6;C6=0.4;R5=1;R6=2;L2=0.7;e4=4;
for i=0.5
    figure(1)
...
% the 2nd line
R1=2.3;e1=2;B=2.5;e2=2;C4=1.8;R3=1.5;R4=3;L1=1.2;e3=6;C6=1.2;R5=1;R6=0.8;L2=0.7;e4=4;
for j=0.3
...
%%{
%the 3rd line
R1=2.3;e1=2;B=2.5;e2=2;C4=3;R3=1.5;R4=3;L1=1.2;e3=6;C6=2;R5=1;R6=1.2;L2=0.7;e4=4;
for k=0.3
    ...
    grid on
    hold on  
    legend({'b=0.1','b=0.3','b=0.5'},'location','northeast');
end
%%}
% the small figure
...
R1=2.3;e1=2;B=2.5;e2=2;C4=1.8;R3=1.5;R4=3;L1=1.2;e3=6;C6=1.2;R5=1;R6=2;L2=0.7;e4=4;
for j=0.3
    [t,x]=ode45(@(t,x)dianchi(t,x,R1,e1,B,e2,C4,R3,R4,L1,e3,C6,R5,R6,L2,e4),[0 50],[0.5 j 0.3]);
...
%%{
R1=2.3;e1=2;B=2.5;e2=2;C4=3;R3=1.5;R4=3;L1=1.2;e3=6;C6=2;R5=1;R6=2;L2=0.7;e4=4;
for k=0.3
    [t,x]=ode45(@(t,x)dianchi(t,x,R1,e1,B,e2,C4,R3,R4,L1,e3,C6,R5,R6,L2,e4),[0 50],[0.5 0.3 k]);
